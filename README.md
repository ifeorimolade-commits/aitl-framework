...
**An accessibility evaluation tool for AI-generated user interfaces. It applies the AI-Generated Interface Accessibility Assurance Framework (AIAAF).**
...
AITL is an evaluation tool that addresses this layer. It applies the AI-Generated Interface Accessibility Assurance Framework (AIAAF), the evaluation framework comprising the six dimension rubric, the
generative failure pattern taxonomy (P1 to P8), the 0 to 5 scoring scale, and the
...
| Path | Contents |
|---|---|
| [`SPECIFICATION.md`](SPECIFICATION.md) | The full specification (v0.1): the AIAAF framework and AITL that applies it |
...
This is an early stage, actively developed project. Current phase:
