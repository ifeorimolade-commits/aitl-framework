...
## Methodology Specification — Version 0.1 (Working Draft)
...
AITL is an evaluation methodology for the accessibility of AI-generated user
...
generative failure-pattern taxonomy (P1–P8), the 0–5 scoring scale with its
...
output against that definition; AITL is the process (§6) that applies AIAAF —
...
Each dimension is scored 0–5 with element-level findings recorded beneath it.
...
3. **Evaluate:** score D1–D6 element by element, with keyboard and
...
- **v0.1 (July 2026)** — initial specification: six-dimension rubric, 0–5
