// AITL detection engine (Node) — automated layer of the AITL methodology v0.1
// Detects the generative failure-pattern taxonomy (P1–P8) + structural defects.
...
export function scan(html) {
  ...
  return {
    ...
    note: "Automated detection covers the machine-detectable layer of the AITL methodology only; contextual judgments are routed to human and assistive-technology-user review by design.",
  };
}
