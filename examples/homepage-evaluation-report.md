...
| D6 Generative-pattern resistance | 1/5 | Exhibits all eight taxonomy patterns (P1–P8) |
...
- **Release gate:** findings 1–2 each independently block a task step for AT users → **fails the gate** until resolved.
...
*Generated with the AITL methodology v0.1. This report supports, and does not
